...
##################################################################
    ...
    if S1s[0].tags['step'] < 2:
        ...
        if 'S0_reduced_free_energy' in df.columns:
        ...
        if 'S0_oxidized_free_energy' in df.columns:
             df['S1_oxidation_free_energy (eV)'] = (df['S1_reactant_free_energy'] - df['S0_oxidized_free_energy']) * 27.211
